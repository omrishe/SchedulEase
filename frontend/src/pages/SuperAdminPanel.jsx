...
function SuperAdminPanel() {
  ...
  const [formData, setFormData] = useState({
    ...
    storeAnnouncement: "",
    storeSlug: "",
    services: [{ name: "Haircut", price: "20", serviceNote: "Includes wash" }],
  });
    ...
    <div>
      <form>
        ...
        <input
          name="storeNote"
          onChange={handleChange}
          value={formData["storeNote"]}
        />
        <label htmlFor="storeAnnouncement">store announcement</label>
        <input
          name="storeAnnouncement"
          onChange={handleChange}
          value={formData["storeAnnouncement"]}
        />
        <button type="submit" onClick={createNewStore}>
          create a new store
        </button>
      </form>
